...
public class EsKeywordIndexService implements KeywordIndexService {
    ...
    /**
     * ES 单字段默认上限（Lucene 的 32766 * 2 bytes 近似值），超长内容截断，避免整批写入失败
     */
    ...
    public void indexDocumentChunks(String collectionName, String docId, List<VectorChunk> chunks) {
        ...
        try {
            ...
            throw new IllegalStateException(
                    "ES 关键词索引写入失败, collection=" + collectionName + ", docId=" + docId, e);
        }
    }
    ...
    public void deleteDocumentIndex(String collectionName, String docId) {
        try {
            ...
            throw new IllegalStateException(
                    "ES 关键词索引删除失败, collection=" + collectionName + ", docId=" + docId, e);
        }
    }
    ...
    public void deleteChunkById(String collectionName, String chunkId) {
        ...
        try {
            ...
            throw new IllegalStateException(
                    "ES 关键词索引删除失败, collection=" + collectionName + ", chunkId=" + chunkId, e);
        }
    }
    ...
    public void deleteChunksByIds(String collectionName, List<String> chunkIds) {
        ...
        try {
            ...
            throw new IllegalStateException("ES 关键词索引批量删除失败, collection=" + collectionName, e);
        }
    }
    ...
    public void deleteByCollection(String collectionName) {
        try {
            ...
            throw new IllegalStateException("ES 关键词索引按知识库删除失败, collection=" + collectionName, e);
        }
    }
    ...
    private void ensureSharedIndex() {
        ...
        try {
            ...
            throw new IllegalStateException("ES 关键词共享索引创建失败, index=" + index, e);
        }
    }
