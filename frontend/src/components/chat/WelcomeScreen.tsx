...
import { ArrowUpRight, Bot, Brain, GraduationCap, Lightbulb, Send, Square, Wifi, Wrench } from "lucide-react";
...
const PRESET_ICONS = [GraduationCap, Wifi, Wrench];

const DEFAULT_PRESETS: PromptPreset[] = [
  {
    title: "选课与退改选",
    description: "查询选课资格、安排与特殊补退选",
    prompt: "湖南大学本科生如何完成选课、退课和补退选？请区分普通选课与特殊情况，并以最新通知为准说明办理渠道和注意事项。",
    icon: GraduationCap
  },
  {
    title: "开通校园网",
    description: "获取开通、接入与流量处理指引",
    prompt: "湖南大学学生如何通过个人门户开通校园网？宿舍有线网、校园 Wi-Fi 和流量超额后分别应该如何操作？",
    icon: Wifi
  },
  {
    title: "校园生活报修",
    description: "快速查找宿舍生活设施报修方式",
    prompt: "湖南大学宿舍水电等生活设施需要报修时，线上报修路径、线下事务大厅入口和提交报修时需要填写哪些信息？",
    icon: Wrench
  }
];
      ...
      <div className="relative w-full max-w-[860px]">
        ...
        >
          ...
          <h1 className="mt-4 font-display text-4xl leading-tight tracking-tight text-[#111827] sm:text-5xl md:text-6xl">
            让校内信息，
            <span className="text-gradient">一问即达</span>
          </h1>
          <p className="mt-4 text-base text-[#4B5563] sm:text-lg">
            聚合校内通知、办事指南与服务信息，帮助你快速找到可信答案。
          </p>
        </div>
