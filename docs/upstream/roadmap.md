...
| 编号 | 功能 | 功能文档 | 状态 |
| --- | --- | --- | --- |
| UP-06 | Elasticsearch 关键词检索通道 | `features/up-06-es-keyword-channel.md` | 未开始 |
| UP-01 | 检索通道配置一致性校验（通道后端类型引入后才有意义，随 UP-06 落地） | `features/up-01-channel-config-validation.md` | 未开始 |
